...
def generate_ld_sp_hl(writer):
    ...
    writer.writerow([opcode_hex, 2, f"LD sp, hl M2", "HL", "NONE", "NONE", "NONE", "HL_TO_SP", 1, 0, 1])
...
def generate_push_rr(writer, registers):
    ...
    for d_code, d_name in registers.items():
        ...
        writer.writerow([opcode_hex, 2, f"PUSH {d_name} M2", "SP", "NONE", "NONE", "NONE", "SP_DEC", 1, 0, 0])
